function behaviorMapping(){
    return {
        ...
        removeBehavior(i){
            ...
            $.ajax({
                type: "POST",
                url: "/characters/delete-behaviour",
                data: {
        ...
        addBehavior(){
            ...
            $.ajax({
                type: "POST",
                url: "/characters/add-new-behaviour",
                data: {
        ...
        updateBehavior(){
            ...
            $.ajax({
                type: "POST",
                url: "/characters/update-behaviour",
                data: {
        ...
        init(){
            fetch('/characters/get-behaviors', {
				method: 'POST',
			...
			.then((data) => {
				...
				for(let i = 0; i < behavior_data.length; i++){
                    if (behavior_data[i]['fields'].behavior_value == '+ve') {
            ...
            // use this to populate the page

            // let behavior = [true, false];
            // let impact = [-5, -4, -3, 3, 4, 5];
            // let feasibility = [-5, -4, -3, 3, 4, 5];
            
            // for(let i = 0; i < 16; i++){
            //     this.behaviors.push({
            //         id: i+1,
            //         heading: randomStr(6+i),
            //         description: randomStr(26+i),
